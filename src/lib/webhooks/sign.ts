...
//
// Every delivery carries an `X-Rookie-Signature` header so receivers
// can verify the request really came from ROOKIE CRM and wasn't tampered
// with or replayed. The scheme is Stripe-style:
//
//   X-Rookie-Signature: t=<unix_seconds>,v1=<hex HMAC-SHA256>
//
...
/**
 * Build the `X-Rookie-Signature` header value for `rawBody`, signed
...
/**
 * Verify a signature header. Exposed so a rookie-to-rookie integration
