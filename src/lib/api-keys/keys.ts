...
//
// Why the `rookie_live_` prefix
//   - Self-identifying: a leaked string is instantly recognisable as
//     a rookie key (handy for secret-scanners like GitGuardian).
//   - Forward-compatible: leaves room for a `rookie_test_` variant if
...
export const API_KEY_PREFIX = 'rookie_live_';
